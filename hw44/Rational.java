...
// Team It's December Tomorrow (or today) - Alexia Leong and Eric Wong
// APCS1 p2
...
public class Rational implements Comparable
{
	...
	if (!(other instanceof Rational)){  //if other is not a Rational
	    throw new ClassCastException("\nThe variable is not a Rational.");
	}
	else{ //from hw37
	    Rational a = (Rational) other;  //typecast here
	    thisNumerator = _numerator * a._denominator;
	    otherNumerator = _denominator * a._numerator;
	}
	...
	System.out.println( "r > t: " + "\nExpecting a negative number \nActual: " +  r.compareTo(t) );
	System.out.println( "r > s: " + "\nExpecting a positive number \nActual: " + r.compareTo(s) );
	System.out.println( "s > t: " + "\nExpecting a negative number \nActual: " +s.compareTo(t) );
	//System.out.println( "s > a: " + "\nExpecting a message from exception \nActual: " +s.compareTo(a) ); //tests for exception message
