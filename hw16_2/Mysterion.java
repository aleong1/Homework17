...
public class Mysterion{
	...
	System.out.println(lessorgreater(a, 0, 4, 2));
	System.out.println("--------------------------------");		   

	int[] b = {1,2,3,4,5};  //size 5 ascending
	System.out.println(lessorgreater(b, 0, 4, 2));
	System.out.println("--------------------------------");

	int[] c = {5,4,3,2,1}; //size 5 descending
	System.out.println(lessorgreater(c, 0, 4, 2));
	System.out.println("--------------------------------");

	int[] d = {9,4,1,10,3,8}; //size 6 random
	System.out.println(lessorgreater(d, 0, 5, 2));
	System.out.println("--------------------------------");

	int[] e = {7,6,9,3,1,10,2};  //size 7 random
	System.out.println(lessorgreater(e, 0, 6, 3));
	System.out.println("--------------------------------");

	int[] f = {7,6,9,3,3,3,6};  //size 7 repeating numbers
	System.out.println(lessorgreater(f, 0, 6, 3));
	System.out.println("--------------------------------");
